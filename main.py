...
def frame_du_jeu():
    """
    frame du jeu, elle est appeler a l'utilisation du bouton pour interagire avec l'utilisateur
...
ma_fenettre.geometry("640x520")

dessin_pendue = tk.Canvas(ma_fenettre, width = 400, height = 400, bg = "Grey")
...
liste_image = [tk.PhotoImage(file = r"pendu_0.gif", master = ma_fenettre),  #liste permetant de modifier les image rapidement et de forcer le chargement des images au début
